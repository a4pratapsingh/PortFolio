...
function Header() {
  return (
    ...
    items-center justify-center gap-4'>
        ...
        >
            <Image src={assets.profile_image} alt='' className='rounded-full
            w-32'/>
        </motion.div>
        <motion.h3 
        ...
        className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-sans' >
                Hi! I'm Ankit Singh <Image src={assets.hand_icon} alt='' 
        ...
        className='max-w-2xl mx-auto font-sans'>I'm a Full Stack Web Developer and Data Scientist, 
            skilled in building end-to-end web solutions and 
            leveraging data to drive insights through machine 
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            whileInView={{y: 0, opacity:1}}
            transition={{duration:0.6, delay:1}}
            href="/Ankit-Singh-resume.pdf" download 
