    ...
    >
        ...
        gap-20 my-20'>
            ...
            className='w-64 sm:w-80 rounded-3xl max-w-none'>
                <Image src={assets.user_img} alt='user'
            ...
            className='flex-1 w-full'>
                ...
                <p className='mb-10 max-w-2xl font-sans'>I'm a skilled Full Stack Web Developer and 
                    ...
                    web applications and leveraging data to 
                    drive insights. I specialize in end-to-end 
                    development and advanced analytics, delivering 
